...
// cache miss stall management
uint8_t IC_STALL, DC_STALL, DC_WRITE;
int IC_STALL_CYCLE, IC_RUN_CYCLE, DC_STALL_CYCLE, DC_RUN_CYCLE;


/* global variable -- pipeline state */
extern CPU_State CURRENT_STATE;
extern pipereg_IFID IFID;
extern pipereg_IDEX IDEX;
extern pipereg_EXM EXM;
extern pipereg_EXM EXM_bak; // for dcache stall
extern pipereg_MWB MWB;

// utilities
// creates 64b bitmask of specified len
uint64_t mask_64(int len);
// get inclusive bits [hi:lo] from 64b uint
